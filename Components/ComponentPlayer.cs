	...
	public class ComponentNPlayer : ComponentPlayer, IUpdateable
	{
		public new void Update(float dt)
		{
			...
			if (m_subsystemTime.PeriodicGameTimeEvent(0.5, 0))
			{
				...
				if ((readOnlyList.Count > 0 && ClothingBlock.GetClothingData(readOnlyList[readOnlyList.Count - 1]).DisplayName == Utils.Get("Ǳˮͷ��")) || (ComponentBody.ImmersionFluidBlock != null && ComponentBody.ImmersionFluidBlock.BlockIndex == RottenMeatBlock.Index))
				{
